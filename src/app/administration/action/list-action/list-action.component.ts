...
export class ListActionComponent implements OnInit {
  ...
  label:  string[] = ['#', 'Nome', 'Origem Status', 'Destinação Status', 'Outro', 'Descrição'];
  cols:   string[] = ['id', 'name', 'origin_status_id', 'destination_status_id', 'other_than', 'description'];
  displayedColumns: string[] = ['id', 'name', 'origin_status_id', 'destination_status_id', 'other_than', 'description'];
